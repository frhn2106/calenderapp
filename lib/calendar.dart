...
import 'package:calenderapp/src/calendar_header.dart';
import 'package:calenderapp/src/default_styles.dart';
import 'package:calenderapp/src/weekday_row.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart'
    show DateFormat;
import 'classes/multiple_marked_dates.dart';
export 'package:calenderapp/classes/event_list.dart';
...
class Calendar<T extends EventInterface> extends StatefulWidget {
  ...
  Calendar({
    ...
    this.todayBorderColor = Colors.black,
    this.todayButtonColor = Colors.black,
...
class _CalendarState<T extends EventInterface>
  ...
  initState() {
    ...
    minDate = widget.minSelectedDate ?? DateTime(2000);
    ...
    firstDayOfWeek = widget.firstDayOfWeek ??
        (_localeDate.dateSymbols.FIRSTDAYOFWEEK + 2) % 7;
